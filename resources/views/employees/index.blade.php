...
@section('page-subtitle', 'Kelola data karyawan — edit manual jabatan, email, tanggal masuk, dan informasi lainnya')

@section('content')
<div class="card overflow-hidden">
    <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
        <p class="text-sm text-slate-500">{{ $employees->count() }} karyawan terdaftar</p>
    </div>
